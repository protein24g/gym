...
export class TrainerController {
  ...
  async create(@Req() request: Request, @Param('userId') userId: number) {
    const user = request.user as AuthPayload;
    await this.trainerService.create(user, userId);
  }
  ...
  async delete(@Req() request: Request, @Param('userId') userId: number) {
    const user = request.user as AuthPayload;
    await this.trainerService.delete(user, userId);
  }
